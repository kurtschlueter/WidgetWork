...
Chart.types.Bar.extend({
    ...
    initialize: function (data) {
        ...
        this.buildScale( ["January", "February", "March", "April", "May", "June", "July"]);

        this.BarClass.prototype.base = this.scale.endPoint;

        this.eachBars(function (bar, index, datasetIndex) {
            helpers.extend(bar, {
                width: this.scale.calculateBarWidth(7),
                x: this.scale.calculateBarX(7, datasetIndex, index),
...
window.onload = function () {
    ...
    window.myBar = new Chart(ctx).MyBar(barChartData, {animation: false});
}